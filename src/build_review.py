...
FORM_GROUPS: dict[str, list[str]] = {
    ...
    "스크럽": ["스크럽", "필링", "각질제거"],
    # --- 마스크·패치 ---
    "마스크팩": ["마스크팩", "마스크", "시트", "페이스팩"],
    "패치": ["패치", "코팩", "아이패치", "아이팩", "필름", "밴드"],
    # --- 자외선 ---
    ...
    "스타일링": ["왁스", "스타일링", "포마드"],
    "염색": ["염색", "헤어컬러", "컬러샴푸"],
    "두피토닉": ["두피토닉", "스칼프토닉", "헤어토닉"],
    # --- 바디·기타 ---
    # 바디샴푸는 한국에서 바디워시와 같은 말로 쓰인다(실측: 팡셰 드 부케
    # 바디샤워 = 바디샴푸). 넣지 않으면 샴푸 그룹에만 걸려 불일치가 된다.
