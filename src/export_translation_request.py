...
10. **목록을 다 옮긴 뒤, 맨 아래에 피드백을 남겨 주세요.** 아래 구분선을
   그대로 쓰고 그 뒤에 자유롭게 적으면 됩니다. 구분선 아래는 기계가
   읽지 않으니 형식에 얽매이지 마세요.
   ...
   **적어 주면 좋은 것**
   - 규칙에 없어서 매번 망설인 표현. 어떻게 옮겼는지도 함께.
   - 이 목록에서 여러 번 나온 패턴. 규칙으로 만들면 다음 회차가 빨라집니다.
     (예: "○○ 브랜드는 라인명이 숫자로만 돼 있어 헷갈렸다")
   - 규칙끼리 부딪힌 곳. 어느 쪽을 따랐는지.
   - 비운 줄이 있다면 **왜 비웠는지**. 브랜드를 몰라서인지, 상품명이
     잘려 있어서인지, 화장품이 아닌 것 같아서인지에 따라 대처가 다릅니다.
   - 이 지시문에서 고쳤으면 하는 부분.

   이 피드백은 번역 규칙집에 그대로 반영됩니다. 같은 고민을 다음 사람이
   반복하지 않게 하는 게 목적이니, 사소해 보여도 적어 주세요.
