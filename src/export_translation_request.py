...
**규칙**
1. 출력은 `상품번호|한국어명` 형식 한 줄씩. 설명·인사·머리말 없이 목록만 주세요.
2. 맨 앞의 상품번호(10자리 숫자)는 **한 글자도 바꾸지 말고 그대로** 옮기세요.
   순서를 바꾸거나 줄을 빼지 마세요.
...
- エクソソーム → 엑소좀 (○) / 엑소솜 (×)
- ブレミッシュ → 블레미쉬 (○) / 블레미시 (×)
- 두피·미백·모공·히알루론산·자외선 차단제는 그대로 (한국에서도 쓰는 말)

**붙여 쓰는 말 (한국 상품명 표기)**
- 선크림 · 선스틱 · 선세럼 · 선쿠션 · 아이크림 · 젤크림
- 토너패드 · 마스크팩 · 클렌징폼 · 클렌징오일
- 바디로션 · 바디워시 · 헤어오일 · 헤어에센스
