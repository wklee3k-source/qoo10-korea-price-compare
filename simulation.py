...
def t28_translation_cost_optimization():
    ...
    try:
        ...
        try:
            ...
            batch_100 = mod.MAX_BATCH_SIZE == 100
    ...
    ok = has_cache_control and uses_full_prompt_in_call and prompt_crosses_threshold is True and batch_100 and default_matches_max
    check("28 번역 비용절감(캐싱+배치확대)", ok,
          f"cache_control{has_cache_control} FULL프롬프트사용{uses_full_prompt_in_call} "
          f"임계값초과{prompt_crosses_threshold} 배치100{batch_100} 기본값일치{default_matches_max}")
